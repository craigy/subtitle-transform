...
var args12645 = [];
var len__7629__auto___12648 = arguments.length;
var i__7630__auto___12649 = (0);
while(true){
if((i__7630__auto___12649 < len__7629__auto___12648)){
args12645.push((arguments[i__7630__auto___12649]));

var G__12650 = (i__7630__auto___12649 + (1));
i__7630__auto___12649 = G__12650;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args12645.length)].join('')));
...
while(true){
if(!((coll__$1 == null))){
var G__12652 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__12653 = cljs.core.next(coll__$1);
unmixed_hash = G__12652;
coll__$1 = G__12653;
continue;
} else {
return unmixed_hash;
...
var G__12654 = n__$1;
var G__12655 = y;
var G__12656 = cljs.core.imul(z,z);
n = G__12654;
y = G__12655;
z = G__12656;
continue;
...
var G__12657 = n__$1;
var G__12658 = cljs.core.imul(z,y);
var G__12659 = cljs.core.imul(z,z);
n = G__12657;
y = G__12658;
z = G__12659;
continue;
...
var G__12660 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__12661 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__12660;
index__$1 = G__12661;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__12663 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__12663) : instaparse.auto_flatten_seq.true_count.call(null,G__12663));
})() - (1)))){
...
var G__12664 = v;
var G__12665 = cljs.core.pop(index);
v = G__12664;
index = G__12665;
continue;
...
var args12666 = [];
var len__7629__auto___12669 = arguments.length;
var i__7630__auto___12670 = (0);
while(true){
if((i__7630__auto___12670 < len__7629__auto___12669)){
args12666.push((arguments[i__7630__auto___12670]));

var G__12671 = (i__7630__auto___12670 + (1));
i__7630__auto___12670 = G__12671;
continue;
} else {
}
break;
...
var x__7217__auto__ = (((self == null))?null:self);
var m__7218__auto__ = (instaparse.auto_flatten_seq.conj_flat[goog.typeOf(x__7217__auto__)]);
if(!((m__7218__auto__ == null))){
return (m__7218__auto__.cljs$core$IFn$_invoke$arity$2 ? m__7218__auto__.cljs$core$IFn$_invoke$arity$2(self,obj) : m__7218__auto__.call(null,self,obj));
} else {
var m__7218__auto____$1 = (instaparse.auto_flatten_seq.conj_flat["_"]);
if(!((m__7218__auto____$1 == null))){
return (m__7218__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__7218__auto____$1.cljs$core$IFn$_invoke$arity$2(self,obj) : m__7218__auto____$1.call(null,self,obj));
} else {
...
var x__7217__auto__ = (((self == null))?null:self);
var m__7218__auto__ = (instaparse.auto_flatten_seq.cached_QMARK_[goog.typeOf(x__7217__auto__)]);
if(!((m__7218__auto__ == null))){
return (m__7218__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7218__auto__.cljs$core$IFn$_invoke$arity$1(self) : m__7218__auto__.call(null,self));
} else {
var m__7218__auto____$1 = (instaparse.auto_flatten_seq.cached_QMARK_["_"]);
if(!((m__7218__auto____$1 == null))){
return (m__7218__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7218__auto____$1.cljs$core$IFn$_invoke$arity$1(self) : m__7218__auto____$1.call(null,self));
} else {
...
return (new instaparse.auto_flatten_seq.AutoFlattenSeq(cljs.core.into.cljs$core$IFn$_invoke$arity$2(self__.v,obj),phc,cljs.core.mix_collection_hash(phc,new_cnt),new_cnt,(function (){var or__6554__auto__ = self__.dirty;
if(or__6554__auto__){
...
instaparse.auto_flatten_seq.AutoFlattenSeq.cljs$lang$ctorPrWriter = (function (this__7160__auto__,writer__7161__auto__,opt__7162__auto__){
return cljs.core._write(writer__7161__auto__,"instaparse.auto-flatten-seq/AutoFlattenSeq");
});
...
var G__12673 = instaparse$auto_flatten_seq$flat_vec_helper(acc,fst);
var G__12674 = cljs.core.next(v);
acc = G__12673;
v = G__12674;
continue;
} else {
var G__12675 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__12676 = cljs.core.next(v);
acc = G__12675;
v = G__12676;
continue;
}
...
var x__7217__auto__ = (((self == null))?null:self);
var m__7218__auto__ = (instaparse.auto_flatten_seq.get_vec[goog.typeOf(x__7217__auto__)]);
if(!((m__7218__auto__ == null))){
return (m__7218__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7218__auto__.cljs$core$IFn$_invoke$arity$1(self) : m__7218__auto__.call(null,self));
} else {
var m__7218__auto____$1 = (instaparse.auto_flatten_seq.get_vec["_"]);
if(!((m__7218__auto____$1 == null))){
return (m__7218__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7218__auto____$1.cljs$core$IFn$_invoke$arity$1(self) : m__7218__auto____$1.call(null,self));
} else {
...
var self__$1 = this;
if(cljs.core.truth_((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(self__.flat) : cljs.core.deref.call(null,self__.flat)))){
return (new instaparse.auto_flatten_seq.FlattenOnDemandVector((function (){var G__12678 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(self__.v) : cljs.core.deref.call(null,self__.v));
...
})(),self__.hashcode,self__.cnt,(function (){var G__12679 = cljs.core.with_meta((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(self__.flat) : cljs.core.deref.call(null,self__.flat)),metamap);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__12679) : cljs.core.atom.call(null,G__12679));
})()));
} else {
return (new instaparse.auto_flatten_seq.FlattenOnDemandVector((function (){var G__12680 = cljs.core.with_meta((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(self__.v) : cljs.core.deref.call(null,self__.v)),metamap);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__12680) : cljs.core.atom.call(null,G__12680));
})(),self__.hashcode,self__.cnt,(function (){var G__12681 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(self__.flat) : cljs.core.deref.call(null,self__.flat));
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__12681) : cljs.core.atom.call(null,G__12681));
})()));
}
});
...
instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args12677){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args12677)));
});
...
instaparse.auto_flatten_seq.FlattenOnDemandVector.cljs$lang$ctorPrWriter = (function (this__7160__auto__,writer__7161__auto__,opt__7162__auto__){
return cljs.core._write(writer__7161__auto__,"instaparse.auto-flatten-seq/FlattenOnDemandVector");
});
...
return (new instaparse.auto_flatten_seq.FlattenOnDemandVector((function (){var G__12684 = afs.v;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__12684) : cljs.core.atom.call(null,G__12684));
