...
var G__13187 = o;
(G__13187[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13188__delegate = function (args){
...
while (G__13189__i < G__13189__a.length) {G__13189__a[G__13189__i] = arguments[G__13189__i + 0]; ++G__13189__i;}
  args = new cljs.core.IndexedSeq(G__13189__a,0);
} 
return G__13188__delegate.call(this,args);};
...
return G__13188__delegate(args);
});
...
var G__13195 = jsprops;
(G__13195["defaultValue"] = value);

(G__13195["onChange"] = ((function (G__13195,v,value,on_change){
return (function (p1__13193_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13193_SHARP_);
});})(G__13195,v,value,on_change))
);
...
var vec__13202 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13202,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13202,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13202,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___13207 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13207 == null)){
} else {
var key_13208 = temp__4661__auto___13207;
(jsprops["key"] = key_13208);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13210 = (new reagent.impl.template.NativeWrapper());
(G__13210["name"] = c);
...
var G__13212 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13212) : reagent.impl.template.as_element.call(null,G__13212));
} else {
...
var len__7629__auto___13218 = arguments.length;
var i__7630__auto___13219 = (0);
while(true){
if((i__7630__auto___13219 < len__7629__auto___13218)){
args__7636__auto__.push((arguments[i__7630__auto___13219]));

var G__13220 = (i__7630__auto___13219 + (1));
i__7630__auto___13219 = G__13220;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13216){
var G__13217 = cljs.core.first(seq13216);
var seq13216__$1 = cljs.core.next(seq13216);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13217,seq13216__$1);
});
...
break;
default:
var G__13224 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13224;
continue;
...
var n__7469__auto___13227 = a.length;
var i_13228 = (0);
while(true){
if((i_13228 < n__7469__auto___13227)){
(a[i_13228] = reagent.impl.template.as_element((a[i_13228])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7469__auto___13230 = a.length;
var i_13231 = (0);
while(true){
if((i_13231 < n__7469__auto___13230)){
var val_13232 = (a[i_13231]);
if((cljs.core.vector_QMARK_(val_13232)) && ((reagent.impl.template.key_from_vec(val_13232) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13231] = reagent.impl.template.as_element(val_13232));

var G__13233 = (i_13231 + (1));
i_13231 = G__13233;
continue;
} else {
}
...
var ctx = {};
var vec__13237 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13237,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13237,(1),null);
...
var G__13241 = (cljs.core.count(argv) - first_child);
switch (G__13241) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13241){
